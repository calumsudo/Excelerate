...
#     filepaths = ['dailies_cv/monday.csv', 'dailies_cv/tuesday.csv', 'dailies_cv/wednesday.csv', 'dailies_cv/thursday.csv', 'dailies_cv/friday.csv']

    
#     result, total_gross, total_net, total_fee, error = parse_cv(filepaths, '~/Desktop/Fuck')
