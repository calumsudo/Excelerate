...
#             df["Payable Amt (Gross)"].replace("[\$,]", "", regex=True).astype(float)
#         )
#         df["Payable Amt (Net)"] = (
#             df["Payable Amt (Net)"].replace("[\$,]", "", regex=True).astype(float)
#         )
#         df["Servicing Fee $"] = (
#             df["Servicing Fee $"].replace("[\$,]", "", regex=True).astype(float)
#         )
