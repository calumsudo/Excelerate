...
class CTkScrollbar(CTkBaseClass):
    ...
    def _clicked(self, event):
        ...
        value = max(
            current_scrollbar_length / 2, min(value, 1 - (current_scrollbar_length / 2))
        )
