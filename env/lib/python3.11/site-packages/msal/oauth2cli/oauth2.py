...
class Client(BaseClient):  # We choose to implement all 4 grants in 1 class
    ...
    def _build_auth_request_uri(
        self, response_type, redirect_uri=None, scope=None, state=None, **kwargs
    ):
        ...
        params = self._build_auth_request_params(
            response_type, redirect_uri=redirect_uri, scope=scope, state=state, **kwargs
        )
    ...
    def obtain_token_by_auth_code_flow(
        self, auth_code_flow, auth_response, scope=None, **kwargs
    ):
        ...
        **kwargs
        ...
        resp = super(Client, self).obtain_token_by_refresh_token(
            (
                ...
                if not isinstance(token_item, string_types)
                else token_item
            ),
            scope=scope,
    ...
    def obtain_token_by_assertion(self, assertion, grant_type, scope=None, **kwargs):
