...
FontManager.load_font(
    os.path.join(
        customtkinter_directory, "assets", "fonts", "Roboto", "Roboto-Regular.ttf"
    )
)
FontManager.load_font(
    os.path.join(
        customtkinter_directory, "assets", "fonts", "Roboto", "Roboto-Medium.ttf"
    )
)
...
if (
    FontManager.load_font(
        os.path.join(
            customtkinter_directory, "assets", "fonts", "CustomTkinter_shapes_font.otf"
        )
    )
    is False
):
